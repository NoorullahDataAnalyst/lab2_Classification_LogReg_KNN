...
### 🎯 Lab 3: Classification Models I - Logistic Regression & KNN
**File:** `lab3_Classification_LogReg_KNN.ipynb`
...
```
ML-Scikit-Learn-Labs/
│
├── README.md
├── Lab3_Classification_LogReg_KNN.ipynb
```
